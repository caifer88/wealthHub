    ...
    try:
        ...
        for asset in active_assets:
             ...
             if asset_id in nav_mapping:
                 ...
                 participations = prev_history[0].participations if prev_history and prev_history[0].participations is not None else Decimal("0.0")
                 contribution = prev_history[0].contribution if prev_history and prev_history[0].contribution is not None else Decimal("0.0")
                 mean_cost = prev_history[0].mean_cost if prev_history and prev_history[0].mean_cost is not None else Decimal("0.0")
